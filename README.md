...
## Table of Contents
  * [1. User Experience](#1-user-experience)
    + [1.1. Strategy Phase](#11-strategy-phase)
    + [1.2. Scope Phase](#12-scope-phase)
    + [1.3. Structure Phase](#13-structure-phase)
    + [1.4. Skeleton Phase](#14-skeleton-phase)
    + [1.5. Surface Phase](#15-surface-phase)
      - [1.5.1. Colour theme](#151-colour-theme)
      - [1.5.2. Font styling](#152-font-styling)
    + [1.6. User Stories](#16-user-stories)
      - [1.6.1. Customer User Stories](#161-customer-user-stories)
      - [1.6.2. Site User Stories](#162-site-user-stories)
      - [1.6.3. Site Owner Stories](#163-site-owner-stories)
  * [2. Features](#2-features)
    + [2.1. General Features](#21-general-features)
      - [2.1.1. Base Elements](#211-base-elements)
      - [2.1.2. Home Page](#212-home-page)
      - [2.1.3. Shop Page](#213-shop-page)
      - [2.1.4. Product Info Page](#214-product-info-page)
      - [2.1.5. Shopping bag Page](#215-shopping-bag-page)
      - [2.1.6. Checkout Page](#216-checkout-page)
      - [2.1.7. Checkout Success Page](#217-checkout-success-page)
      - [2.1.8. Profile Page](#218-profile-page)
      - [2.1.9. Product Admin Page](#219-product-admin-page)
      - [2.1.10. Tutoring Page](#2110-tutoring-page)
      - [2.1.11. FAQs Page](#2111-faqs-page)
    + [2.2. Special Features](#22-special-features)
    + [2.3. Future Features](#23-future-features)
  * [3. Information Architecture](#3-information-architecture)
    + [3.1. Databases](#31-databases)
    + [3.2. Data Models](#32-data-models)
      - [3.2.1. User Model](#321-user-model)
      - [3.2.2. Order Model](#322-order-model)
      - [3.2.3. Line Order Model](#323-line-order-model)
      - [3.2.4. FAQ Model](#324-faq-model)
      - [3.2.5. Review Model](#325-review-model)
      - [3.2.6. Categories Model](#326-categories-model)
      - [3.2.7. Product Model](#327-product-model)
      - [3.2.8. Tutoring Model](#328-tutoring-model)
  * [4. Technologies Used](#4-technologies-used)
    + [4.1. Languages](#41-languages)
    + [4.2. Tools](#42-tools)
    + [4.3. Framework & Libraries](#43-framework---libraries)
    + [4.4. Databases](#44-databases)
    + [4.5. Other](#45-other)
  * [5. Testing](#5-testing)
  ...
  * [7. Credit](#7-credit)
    ...
    + [7.2. Acknowledgement](#72-acknowledgement)
