...
ALLOWED_HOSTS = ['studyhaven.herokuapp.com', 'localhost']
...
if 'USE_AWS' in os.environ:
    # Allow to Cache static files for a long period of time for better UX
...
# Sending real emails to customer
if 'DEVELOPMENT' in os.environ:
    """ Log email confirmations to console """
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_EMAIL_SENDER = 'studyhavenltd@gmail.com'
else:
    ...
    DEFAULT_EMAIL_SENDER = os.environ.get('EMAIL_HOST_USER')
